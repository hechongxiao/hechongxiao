    ...
    private void setMyControlListener() {
        myControl.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                th = progress;
                myTextView.setText("The threshold is: "+th);
            }
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            for (int i = 0; i < bmp.getWidth(); i++) {
                ...
                if (255*3-(red(pixels[i])+green(pixels[i])+blue(pixels[i])) > th) {
            ...
            bmp.getPixels(pixels, 0, bmp.getWidth(), 0, startY3, bmp.getWidth(), 1); // (array name, offset inside array, stride (size of row), start x, start y, num pixels to read per row, num rows to read)
            ...
            bmp.getPixels(pixels, 0, bmp.getWidth(), 0, startY4, bmp.getWidth(), 1); // (array name, offset inside array, stride (size of row), start x, start y, num pixels to read per row, num rows to read)
            ...
            bmp.getPixels(pixels, 0, bmp.getWidth(), 0, startY5, bmp.getWidth(), 1); // (array name, offset inside array, stride (size of row), start x, start y, num pixels to read per row, num rows to read)
            ...
            canvas.drawCircle(COM5, startY5, 5, paint5);


            // also write the value as text
            canvas.drawText("COM1 = " + COM, 10, 200, paint1);
